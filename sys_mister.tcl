...
# Core build/QIP assignments are intentionally owned by HardDrivin.qsf and
# files.qip. The pin/device assignments above and below remain identical to
# the pinned MiSTer Template source.
